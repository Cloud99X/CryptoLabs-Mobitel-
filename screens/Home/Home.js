        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          <View style={styles.segment}>
            ...
            <TouchableOpacity onPress={() => setCurrentTab('following')}>
              <Text
                style={
                  tab === 'following' ? styles.currTab : styles.textStyle2
                }>
                Following
              </Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => setCurrentTab('News')}>
              <Text style={tab === 'News' ? styles.currTab : styles.textStyle2}>
                News
              </Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => setCurrentTab('Analysis')}>
              <Text
                style={tab === 'Analysis' ? styles.currTab : styles.textStyle2}>
                Analysis
              </Text>
            </TouchableOpacity>
          </View>
